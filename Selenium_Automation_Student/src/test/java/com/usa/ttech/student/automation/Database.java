...
public class Database {
	...
	public static void main(String[] args) throws Throwable
 {
		...
		ResultSet rs = stmt.executeQuery("Select* from employees");
				...
				//"\r\n" + 
				//"Select * From (select employee_id,first_name,last_name,salary, DENSE_RANK() over(ORDER BY salary desc)  rank from employees) Where rank= 2");
...
System.out.println("Data Extraction done successfully");
